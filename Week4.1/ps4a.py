...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for char in word:
            thisHand[char] = thisHand.get(char, 0)-1
        return all(i >= 0 for i in thisHand.values())
    else:
        return False
...
def calculateHandlen(hand):
    ...
    returns: integer
    """
    return sum(hand[char] for char in hand)
...
def playGame(wordList):
    ...
    while True:
        ...
        elif answer == 'r' and hand:
            playHand(hand, wordList,HAND_SIZE)
        elif answer == 'r' and not hand:
